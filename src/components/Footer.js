  ...
  return (
    <div className='footer'>
      <div className='footer-container'>
            <div className="email">
            <a href="mailto:mdagency221@gmail.com" target="_blank"> <h4><FaMailBulk size={20} style={{ color:"#0072C6", marginRight:"2rem" }}/>
                mdagency221@gmail.com</h4>  </a>
                <br></br>
            ...
            <a href="https://www.facebook.com/cutshotconsulting/" target="_blank"> <FaFacebook size={30} style={{ color:"#3b5998", marginRight:"1rem" }}/> </a>
